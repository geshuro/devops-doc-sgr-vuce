...
User=spark
Group=spark
ExecStart=/opt/spark/sbin/start-slave.sh spark://192.168.130.147:7077
...
hostnamectl status
sudo hostnamectl --static set-hostname atcapaext-spark-01

#en cada servidor con su hostname
sudo vi /etc/hosts
<<COMMENT
    192.168.130.147   atcapaext-spark-01
COMMENT
sudo reboot 
